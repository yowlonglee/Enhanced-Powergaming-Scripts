...
If upgrading from an earlier version before v2.0, I recommend uninstalling all mod components, and replace all files with the new ones before doing a fresh install.PLEASE NOTE: SCS is no longer required to use these scripts. 
## What Do These Offer
