...
This mod is a collection of nine player ai scripts designed for use in Baldur's Gate II: Enhanced Edition and the Enhanced Edition Trilogy. With these scripts, you can focus on the fighting aspect of combat while these take care of the nuances in the background. Sword Coast Stratagems (SCS) is required for these scripts, and they are tailored to work with the following installs: a standard SCS install, SCS + Icewind Dale Spells (SCS Component), and SCS + Spell Revisions (Revised).
## Who Am I
