...
- All Games
  ...
  - Updated checks to account for no casting delay when under the effects of Improved Alacrity.
  ...
  - Added use of the following disabling spells: Slow, Sleep, Hold Person (Cleric & Wizard), Confusion (Wizard), Emotion: Hopelessness, Cleric Silence.
- BG2EE and EET
