...
set "mod_name=Enhanced Powergaming Scripts"
set "mod_version=v2.3"
set mod_folder=powergamingscripts

REM /* MODIFY: list here which IE games the mod is compatible with, from this list of possibilities: */
REM /* %bgiiee%, %iwd1%, %iwdee%, %iwd2%, %iwd2ee%, %iwd-in-bg2%, %pst%, %pstee%, %eet% */
set "compatible_games=%eet%, or %bgiiee%"
...
set mod_readme=https://gibberlings3.github.io/Documentation/readmes/readme-Enhanced-Powergaming-Scripts.html
